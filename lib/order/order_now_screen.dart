    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Company Account Number / ID: \nY87Y-HJF9-CVBN-4321", style: TextStyle(
                  fontSize: Dimensions.height18,
          ...
          Padding(padding: EdgeInsets.fromLTRB(Dimensions.height16, Dimensions.height8, Dimensions.height16, Dimensions.height16),
          child: TextField(
            style: TextStyle(
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: Dimensions.height16),
            child: Text(
              "Shipment Address:", style: TextStyle(
              fontSize: Dimensions.height18,
              color: Colors.white70,
              fontWeight: FontWeight.bold,
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: Dimensions.height16),
            child: Text(
              "Note to Seller:", style: TextStyle(
              fontSize: Dimensions.height18,
              color: Colors.white70,
              fontWeight: FontWeight.bold,
          ...
          //-------pay amount now btn----------
          Padding(padding:
          EdgeInsets.symmetric(horizontal: Dimensions.height16),
            child: Material(
              color: Colors.red,
      ...
      children:List.generate(selectedCartListItemsInfo!.length, (index){
          ...
          return Container(
            margin: EdgeInsets.fromLTRB(
                Dimensions.height16, index == 0 ? Dimensions.height16: Dimensions.height8,
                Dimensions.height16, index == selectedCartListItemsInfo!.length -1 ? Dimensions.height16: Dimensions.height8),
            ...
            child: Row(
              children: [
                ...
                //----size----
                //----total amount------
                Expanded(child: Padding(padding: EdgeInsets.all(Dimensions.height8),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
        Text(
